        ...
        <div class="row-fluid">
            <div id="left_bar" class="span9">
                ...
                <div id="principal_content">
                    <div class="news">
                        <div class="thenews">
                            <h2><a href="" title="Lire l'article">News 1 : Purit n'est pas un Chinois !</a></h2>

                            <p class="infos_news">Par <a href="" title="Voir le profil de l'auteur" class="auteur_news">Starkadh</a>, il y a <span class="date_news">1 jour</span><a href="" title="Voir les commentaires" class="nombre_commentaires_news">10 commentaires</a></p>

                            <div class="content_news">
                                <div class="row-fluid">
                                    <div class="img_news span2">
                                        <a href="" title="Lire l'article"><img src="style/images/dogwars.jpg"></a>
                                    </div>

                                    <div class="texte_news span10">
                                        <p class="contenu_texte_news">Ça sounds good, si vraiment tu veux te rappeler des souvenirs de ton perroquet, c'est juste une question d'awareness et ça, c'est très dur, et, et, et... c'est très facile en même temps. Tu vas te dire : J'aurais jamais cru que le karaté guy pouvait parler comme ça !</p>
